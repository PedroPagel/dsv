...
type
  ...
  relatorioImportacaoconsumirIn = class;
  { "http://services.senior.com.br"[GblCplx] }
  relatorioImportacaoconsumirOut = class;
  { "http://services.senior.com.br"[Lit][GblCplx] }
  ...
  published
    property codEmp: string Index(IS_OPTN or IS_NLBL or IS_UNQL)read FcodEmp
      write SetcodEmp stored codEmp_Specified;
    property codFil: string Index(IS_OPTN or IS_NLBL or IS_UNQL)read FcodFil
      write SetcodFil stored codFil_Specified;
    property codFor: string Index(IS_OPTN or IS_NLBL or IS_UNQL)read FcodFor
      write SetcodFor stored codFor_Specified;
    property estado: string Index(IS_OPTN or IS_NLBL or IS_UNQL)read Festado
      write Setestado stored estado_Specified;
    property flowInstanceID: string Index(IS_OPTN or IS_NLBL or IS_UNQL)
      read FflowInstanceID write SetflowInstanceID
      stored flowInstanceID_Specified;
    property flowName: string Index(IS_OPTN or IS_NLBL or IS_UNQL)read FflowName
      write SetflowName stored flowName_Specified;
    property numOcp: string Index(IS_OPTN or IS_NLBL or IS_UNQL)read FnumOcp
      write SetnumOcp stored numOcp_Specified;
  end;
  ...
  published
    property erroExecucao: string Index(IS_OPTN or IS_NLBL or IS_UNQL)
      read FerroExecucao write SeterroExecucao stored erroExecucao_Specified;
  end;
  ...
  sapiens_Synccom_senior_g5_co_sup_RelatorioImportacao = interface(IInvokable)
    ...
    function consumir(const user: string; const password: string;
      const encryption: Integer;
      const parameters: relatorioImportacaoconsumirIn)
      : relatorioImportacaoconsumirOut; stdcall;
  end;

function Getsapiens_Synccom_senior_g5_co_sup_RelatorioImportacao
  (UseWSDL: boolean = System.False; Addr: string = ''; HTTPRIO: THTTPRIO = nil)
...
function Getsapiens_Synccom_senior_g5_co_sup_RelatorioImportacao
  (UseWSDL: boolean; Addr: string; HTTPRIO: THTTPRIO)
  : sapiens_Synccom_senior_g5_co_sup_RelatorioImportacao;
const
...
begin
  ...
  Addr := FOracleConnection.MontarURL
    (TypeInfo(sapiens_Synccom_senior_g5_co_sup_RelatorioImportacao));
  try
...
procedure relatorioImportacaoconsumirIn.SetcodEmp(Index: Integer;
...
function relatorioImportacaoconsumirIn.codEmp_Specified(Index: Integer)
  : boolean;
begin
  Result := FcodEmp_Specified;
end;

procedure relatorioImportacaoconsumirIn.SetcodFil(Index: Integer;
  const Astring: string);
begin
  FcodFil := Astring;
...
function relatorioImportacaoconsumirIn.codFil_Specified(Index: Integer)
  : boolean;
begin
  Result := FcodFil_Specified;
end;

procedure relatorioImportacaoconsumirIn.SetcodFor(Index: Integer;
  const Astring: string);
begin
  FcodFor := Astring;
...
function relatorioImportacaoconsumirIn.codFor_Specified(Index: Integer)
  : boolean;
begin
  Result := FcodFor_Specified;
end;

procedure relatorioImportacaoconsumirIn.Setestado(Index: Integer;
  const Astring: string);
begin
  Festado := Astring;
...
function relatorioImportacaoconsumirIn.estado_Specified(Index: Integer)
  : boolean;
begin
  Result := Festado_Specified;
end;

procedure relatorioImportacaoconsumirIn.SetflowInstanceID(Index: Integer;
  const Astring: string);
begin
...
function relatorioImportacaoconsumirIn.flowInstanceID_Specified
  (Index: Integer): boolean;
begin
  Result := FflowInstanceID_Specified;
end;

procedure relatorioImportacaoconsumirIn.SetflowName(Index: Integer;
  const Astring: string);
begin
  FflowName := Astring;
...
function relatorioImportacaoconsumirIn.flowName_Specified
  (Index: Integer): boolean;
begin
  Result := FflowName_Specified;
end;

procedure relatorioImportacaoconsumirIn.SetnumOcp(Index: Integer;
  const Astring: string);
begin
  FnumOcp := Astring;
...
function relatorioImportacaoconsumirIn.numOcp_Specified(Index: Integer)
  : boolean;
begin
...
procedure relatorioImportacaoconsumirOut.SeterroExecucao(Index: Integer;
  const Astring: string);
begin
...
function relatorioImportacaoconsumirOut.erroExecucao_Specified
  (Index: Integer): boolean;
begin
...
InvRegistry.RegisterInterface
  (TypeInfo(sapiens_Synccom_senior_g5_co_sup_RelatorioImportacao),
  'http://services.senior.com.br', 'UTF-8');
InvRegistry.RegisterDefaultSOAPAction
  (TypeInfo(sapiens_Synccom_senior_g5_co_sup_RelatorioImportacao), '');
InvRegistry.RegisterInvokeOptions
  (TypeInfo(sapiens_Synccom_senior_g5_co_sup_RelatorioImportacao), ioLiteral);
{ sapiens_Synccom_senior_g5_co_sup_RelatorioImportacao.consumir }
InvRegistry.RegisterParamInfo
  (TypeInfo(sapiens_Synccom_senior_g5_co_sup_RelatorioImportacao), 'consumir',
  'parameters', '', '[Namespace="http://services.senior.com.br"]');
InvRegistry.RegisterParamInfo
  (TypeInfo(sapiens_Synccom_senior_g5_co_sup_RelatorioImportacao), 'consumir',
  'result', '', '[Namespace="http://services.senior.com.br"]');
RemClassRegistry.RegisterXSClass(relatorioImportacaoconsumirIn,
  'http://services.senior.com.br', 'relatorioImportacaoconsumirIn');
RemClassRegistry.RegisterXSClass(relatorioImportacaoconsumirOut,
  'http://services.senior.com.br', 'relatorioImportacaoconsumirOut');
RemClassRegistry.RegisterSerializeOptions(relatorioImportacaoconsumirOut,
  [xoLiteralParam]);

...
begin
  AddForeignKeys(['CodEmp','CodFil','NumTit','CodTpt','CodFor','CodTns'], ['CodEmp','CodFil','NumTit','CodTpt','CodFor','CodTns']);
  AddPrimaryKeys('CodEmp;CodFil;NumTit;CodTpt;CodFor;SeqMov');
...
procedure T501MCP.RetornarValores();
begin
  FCodEmp := FCodEmpOLD;
  FCodFil := FCodFilOLD;
  FNumTit := FNumTitOLD;

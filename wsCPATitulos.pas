...
type
  ...
  private
    ...
    FdatPpt_Specified: boolean;
    FdesMpt: string;
    FdesMpt_Specified: boolean;
    FdesPor: string;
    FdesPor_Specified: boolean;
    FdesSit: string;
    FdesSit_Specified: boolean;
    FdesTpt: string;
    FdesTpt_Specified: boolean;
    FdscNeg: string;
    FdscNeg_Specified: boolean;
    FfilNfv: string;
    FfilNfv_Specified: boolean;
    ...
    FvlrOri_Specified: boolean;
    FvlrPag: string;
    FvlrPag_Specified: boolean;
    FvlrTot: string;
    FvlrTot_Specified: boolean;
    procedure SetantDsc(Index: Integer; const Astring: string);
    function  antDsc_Specified(Index: Integer): boolean;
    procedure SetcodCrt(Index: Integer; const Astring: string);
    function  codCrt_Specified(Index: Integer): boolean;
    ...
    procedure SetdatPpt(Index: Integer; const Astring: string);
    function  datPpt_Specified(Index: Integer): boolean;
    procedure SetdesMpt(Index: Integer; const Astring: string);
    function  desMpt_Specified(Index: Integer): boolean;
    procedure SetdesPor(Index: Integer; const Astring: string);
    function  desPor_Specified(Index: Integer): boolean;
    procedure SetdesSit(Index: Integer; const Astring: string);
    function  desSit_Specified(Index: Integer): boolean;
    procedure SetdesTpt(Index: Integer; const Astring: string);
    function  desTpt_Specified(Index: Integer): boolean;
    procedure SetdscNeg(Index: Integer; const Astring: string);
    function  dscNeg_Specified(Index: Integer): boolean;
    procedure SetfilNfv(Index: Integer; const Astring: string);
    function  filNfv_Specified(Index: Integer): boolean;
    procedure SetjrsDia(Index: Integer; const Astring: string);
    function  jrsDia_Specified(Index: Integer): boolean;
    procedure SetjrsNeg(Index: Integer; const Astring: string);
    ...
    procedure SetproJrs(Index: Integer; const Astring: string);
    function  proJrs_Specified(Index: Integer): boolean;
    procedure SetsigFil(Index: Integer; const Astring: string);
    function  sigFil_Specified(Index: Integer): boolean;
    procedure SetsitTit(Index: Integer; const Astring: string);
    function  sitTit_Specified(Index: Integer): boolean;
    procedure SetsnfNfv(Index: Integer; const Astring: string);
    function  snfNfv_Specified(Index: Integer): boolean;
    ...
    procedure SetvctPro(Index: Integer; const Astring: string);
    function  vctPro_Specified(Index: Integer): boolean;
    procedure SetvlrAbe(Index: Integer; const Astring: string);
    function  vlrAbe_Specified(Index: Integer): boolean;
    procedure SetvlrAcr(Index: Integer; const Astring: string);
    ...
    procedure SetvlrOri(Index: Integer; const Astring: string);
    function  vlrOri_Specified(Index: Integer): boolean;
    procedure SetvlrPag(Index: Integer; const Astring: string);
    function  vlrPag_Specified(Index: Integer): boolean;
    procedure SetvlrTot(Index: Integer; const Astring: string);
    function  vlrTot_Specified(Index: Integer): boolean;
  published
    property antDsc: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FantDsc write SetantDsc stored antDsc_Specified;
    property codCrt: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FcodCrt write SetcodCrt stored codCrt_Specified;
    property codEmp: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FcodEmp write SetcodEmp stored codEmp_Specified;
    ...
    property datNeg: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FdatNeg write SetdatNeg stored datNeg_Specified;
    property datPpt: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FdatPpt write SetdatPpt stored datPpt_Specified;
    property desMpt: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FdesMpt write SetdesMpt stored desMpt_Specified;
    property desPor: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FdesPor write SetdesPor stored desPor_Specified;
    property desSit: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FdesSit write SetdesSit stored desSit_Specified;
    property desTpt: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FdesTpt write SetdesTpt stored desTpt_Specified;
    property dscNeg: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FdscNeg write SetdscNeg stored dscNeg_Specified;
    property filNfv: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FfilNfv write SetfilNfv stored filNfv_Specified;
    property jrsDia: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FjrsDia write SetjrsDia stored jrsDia_Specified;
    property jrsNeg: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FjrsNeg write SetjrsNeg stored jrsNeg_Specified;
    property mulNeg: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FmulNeg write SetmulNeg stored mulNeg_Specified;
    ...
    property perMul: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FperMul write SetperMul stored perMul_Specified;
    property proJrs: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FproJrs write SetproJrs stored proJrs_Specified;
    property sigFil: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FsigFil write SetsigFil stored sigFil_Specified;
    property sitTit: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FsitTit write SetsitTit stored sitTit_Specified;
    property snfNfv: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FsnfNfv write SetsnfNfv stored snfNfv_Specified;
    property tipJrs: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FtipJrs write SettipJrs stored tipJrs_Specified;
    property tolDsc: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FtolDsc write SettolDsc stored tolDsc_Specified;
    ...
    property vctOri: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FvctOri write SetvctOri stored vctOri_Specified;
    property vctPro: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FvctPro write SetvctPro stored vctPro_Specified;
    property vlrAbe: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FvlrAbe write SetvlrAbe stored vlrAbe_Specified;
    property vlrAcr: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FvlrAcr write SetvlrAcr stored vlrAcr_Specified;
    ...
    property vlrOri: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FvlrOri write SetvlrOri stored vlrOri_Specified;
    property vlrPag: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FvlrPag write SetvlrPag stored vlrPag_Specified;
    property vlrTot: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FvlrTot write SetvlrTot stored vlrTot_Specified;
  end;
  ...
  private
    ...
    FcodFor_Specified: boolean;
    FfilExc: string;
    FfilExc_Specified: boolean;
    FflowInstanceID: string;
    FflowInstanceID_Specified: boolean;
    FflowName: string;
    FflowName_Specified: boolean;
    FidentificacaoSistema: string;
    FidentificacaoSistema_Specified: boolean;
    FsitTit: string;
    FsitTit_Specified: boolean;
    FvctFim: string;
    FvctFim_Specified: boolean;
    ...
    procedure SetcodFor(Index: Integer; const Astring: string);
    function  codFor_Specified(Index: Integer): boolean;
    procedure SetfilExc(Index: Integer; const Astring: string);
    function  filExc_Specified(Index: Integer): boolean;
    procedure SetflowInstanceID(Index: Integer; const Astring: string);
    function  flowInstanceID_Specified(Index: Integer): boolean;
    procedure SetflowName(Index: Integer; const Astring: string);
    function  flowName_Specified(Index: Integer): boolean;
    procedure SetidentificacaoSistema(Index: Integer; const Astring: string);
    function  identificacaoSistema_Specified(Index: Integer): boolean;
    procedure SetsitTit(Index: Integer; const Astring: string);
    function  sitTit_Specified(Index: Integer): boolean;
    procedure SetvctFim(Index: Integer; const Astring: string);
    function  vctFim_Specified(Index: Integer): boolean;
  ...
  published
    ...
    property codEmp:               string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FcodEmp write SetcodEmp stored codEmp_Specified;
    property codFor:               string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FcodFor write SetcodFor stored codFor_Specified;
    property filExc:               string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FfilExc write SetfilExc stored filExc_Specified;
    property flowInstanceID:       string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FflowInstanceID write SetflowInstanceID stored flowInstanceID_Specified;
    property flowName:             string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FflowName write SetflowName stored flowName_Specified;
    property identificacaoSistema: string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FidentificacaoSistema write SetidentificacaoSistema stored identificacaoSistema_Specified;
    property sitTit:               string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FsitTit write SetsitTit stored sitTit_Specified;
    property vctFim:               string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FvctFim write SetvctFim stored vctFim_Specified;
    property vctIni:               string  Index (IS_OPTN or IS_NLBL or IS_UNQL) read FvctIni write SetvctIni stored vctIni_Specified;
  end;
...
procedure titulosConsultarTitulosCPOutTitulos.SetantDsc(Index: Integer; const Astring: string);
begin
  FantDsc := Astring;
  FantDsc_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.antDsc_Specified(Index: Integer): boolean;
begin
  Result := FantDsc_Specified;
end;
...
procedure titulosConsultarTitulosCPOutTitulos.SetdesMpt(Index: Integer; const Astring: string);
begin
  FdesMpt := Astring;
  FdesMpt_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.desMpt_Specified(Index: Integer): boolean;
begin
  Result := FdesMpt_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetdesPor(Index: Integer; const Astring: string);
begin
  FdesPor := Astring;
  FdesPor_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.desPor_Specified(Index: Integer): boolean;
begin
  Result := FdesPor_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetdesSit(Index: Integer; const Astring: string);
begin
  FdesSit := Astring;
  FdesSit_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.desSit_Specified(Index: Integer): boolean;
begin
  Result := FdesSit_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetdesTpt(Index: Integer; const Astring: string);
begin
  FdesTpt := Astring;
  FdesTpt_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.desTpt_Specified(Index: Integer): boolean;
begin
  Result := FdesTpt_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetdscNeg(Index: Integer; const Astring: string);
begin
  FdscNeg := Astring;
  FdscNeg_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.dscNeg_Specified(Index: Integer): boolean;
begin
  Result := FdscNeg_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetfilNfv(Index: Integer; const Astring: string);
begin
  FfilNfv := Astring;
  FfilNfv_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.filNfv_Specified(Index: Integer): boolean;
begin
  Result := FfilNfv_Specified;
end;
...
procedure titulosConsultarTitulosCPOutTitulos.SetnomFor(Index: Integer; const Astring: string);
begin
  FnomFor := Astring;
  FnomFor_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.nomFor_Specified(Index: Integer): boolean;
begin
  Result := FnomFor_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetnumNfv(Index: Integer; const Astring: string);
begin
  FnumNfv := Astring;
  FnumNfv_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.numNfv_Specified(Index: Integer): boolean;
begin
  Result := FnumNfv_Specified;
end;
...
procedure titulosConsultarTitulosCPOutTitulos.SetproJrs(Index: Integer; const Astring: string);
begin
  FproJrs := Astring;
  FproJrs_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.proJrs_Specified(Index: Integer): boolean;
begin
  Result := FproJrs_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetsigFil(Index: Integer; const Astring: string);
begin
  FsigFil := Astring;
  FsigFil_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.sigFil_Specified(Index: Integer): boolean;
begin
  Result := FsigFil_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetsitTit(Index: Integer; const Astring: string);
begin
  FsitTit := Astring;
  FsitTit_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.sitTit_Specified(Index: Integer): boolean;
begin
  Result := FsitTit_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetsnfNfv(Index: Integer; const Astring: string);
begin
  FsnfNfv := Astring;
  FsnfNfv_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.snfNfv_Specified(Index: Integer): boolean;
begin
  Result := FsnfNfv_Specified;
end;
...
procedure titulosConsultarTitulosCPOutTitulos.SetvctPro(Index: Integer; const Astring: string);
begin
  FvctPro := Astring;
  FvctPro_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.vctPro_Specified(Index: Integer): boolean;
begin
  Result := FvctPro_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetvlrAbe(Index: Integer; const Astring: string);
begin
  FvlrAbe := Astring;
  FvlrAbe_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.vlrAbe_Specified(Index: Integer): boolean;
begin
  Result := FvlrAbe_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetvlrAcr(Index: Integer; const Astring: string);
begin
  FvlrAcr := Astring;
  FvlrAcr_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.vlrAcr_Specified(Index: Integer): boolean;
begin
  Result := FvlrAcr_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetvlrCor(Index: Integer; const Astring: string);
begin
  FvlrCor := Astring;
  FvlrCor_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.vlrCor_Specified(Index: Integer): boolean;
begin
  Result := FvlrCor_Specified;
end;
...
procedure titulosConsultarTitulosCPOutTitulos.SetvlrMul(Index: Integer; const Astring: string);
begin
  FvlrMul := Astring;
  FvlrMul_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.vlrMul_Specified(Index: Integer): boolean;
begin
  Result := FvlrMul_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetvlrOde(Index: Integer; const Astring: string);
begin
  FvlrOde := Astring;
  FvlrOde_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.vlrOde_Specified(Index: Integer): boolean;
begin
  Result := FvlrOde_Specified;
end;
...
procedure titulosConsultarTitulosCPOutTitulos.SetvlrPag(Index: Integer; const Astring: string);
begin
  FvlrPag := Astring;
  FvlrPag_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.vlrPag_Specified(Index: Integer): boolean;
begin
  Result := FvlrPag_Specified;
end;

procedure titulosConsultarTitulosCPOutTitulos.SetvlrTot(Index: Integer; const Astring: string);
begin
  FvlrTot := Astring;
  FvlrTot_Specified := True;
end;

function titulosConsultarTitulosCPOutTitulos.vlrTot_Specified(Index: Integer): boolean;
begin
  Result := FvlrTot_Specified;
end;
...
procedure titulosConsultarTitulosCPIn.SetcgcCpf(Index: Integer; const Astring: string);
begin
  FcgcCpf := Astring;
  FcgcCpf_Specified := True;
end;

function titulosConsultarTitulosCPIn.cgcCpf_Specified(Index: Integer): boolean;
begin
...
procedure titulosConsultarTitulosCPIn.SetfilExc(Index: Integer; const Astring: string);
begin
  FfilExc := Astring;
  FfilExc_Specified := True;
end;

function titulosConsultarTitulosCPIn.filExc_Specified(Index: Integer): boolean;
begin
  Result := FfilExc_Specified;
end;
...
procedure titulosConsultarTitulosCPIn.SetidentificacaoSistema(Index: Integer; const Astring: string);
begin
  FidentificacaoSistema := Astring;
  FidentificacaoSistema_Specified := True;
end;

function titulosConsultarTitulosCPIn.identificacaoSistema_Specified(Index: Integer): boolean;
begin
  Result := FidentificacaoSistema_Specified;
end;

procedure titulosConsultarTitulosCPIn.SetsitTit(Index: Integer; const Astring: string);
begin
  FsitTit := Astring;
  FsitTit_Specified := True;
end;

function titulosConsultarTitulosCPIn.sitTit_Specified(Index: Integer): boolean;
begin
  Result := FsitTit_Specified;
end;

procedure titulosConsultarTitulosCPIn.SetvctFim(Index: Integer; const Astring: string);
begin
  FvctFim := Astring;
  FvctFim_Specified := True;
end;

function titulosConsultarTitulosCPIn.vctFim_Specified(Index: Integer): boolean;
begin
  Result := FvctFim_Specified;
end;

procedure titulosConsultarTitulosCPIn.SetvctIni(Index: Integer; const Astring: string);
begin
  FvctIni := Astring;
  FvctIni_Specified := True;
end;

function titulosConsultarTitulosCPIn.vctIni_Specified(Index: Integer): boolean;
begin
  Result := FvctIni_Specified;
end;
...
procedure titulosConsultarTitulosCP2In.SetcgcCpf(Index: Integer; const Astring: string);
begin
  FcgcCpf := Astring;
  FcgcCpf_Specified := True;
end;

function titulosConsultarTitulosCP2In.cgcCpf_Specified(Index: Integer): boolean;
begin
  Result := FcgcCpf_Specified;
end;
...
procedure titulosConsultarTitulosCP2In.SetfilExc(Index: Integer; const Astring: string);
begin
  FfilExc := Astring;
  FfilExc_Specified := True;
end;

function titulosConsultarTitulosCP2In.filExc_Specified(Index: Integer): boolean;
begin
  Result := FfilExc_Specified;
end;
...
procedure titulosConsultarTitulosCP2In.SetidentificacaoSistema(Index: Integer; const Astring: string);
begin
  FidentificacaoSistema := Astring;
  FidentificacaoSistema_Specified := True;
end;

function titulosConsultarTitulosCP2In.identificacaoSistema_Specified(Index: Integer): boolean;
begin
  Result := FidentificacaoSistema_Specified;
end;

procedure titulosConsultarTitulosCP2In.SetsitTit(Index: Integer; const Astring: string);
begin
  FsitTit := Astring;
  FsitTit_Specified := True;
end;

function titulosConsultarTitulosCP2In.sitTit_Specified(Index: Integer): boolean;
begin
  Result := FsitTit_Specified;
end;

procedure titulosConsultarTitulosCP2In.SetvctFim(Index: Integer; const Astring: string);
begin
  FvctFim := Astring;
  FvctFim_Specified := True;
end;

function titulosConsultarTitulosCP2In.vctFim_Specified(Index: Integer): boolean;
begin
  Result := FvctFim_Specified;
end;

procedure titulosConsultarTitulosCP2In.SetvctIni(Index: Integer; const Astring: string);
begin
  FvctIni := Astring;
  FvctIni_Specified := True;
end;

function titulosConsultarTitulosCP2In.vctIni_Specified(Index: Integer): boolean;
begin
  Result := FvctIni_Specified;
end;
...
procedure titulosConsultarTitulosCP2OutTitulos.SetantDsc(Index: Integer; const Astring: string);
begin
  FantDsc := Astring;
  FantDsc_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.antDsc_Specified(Index: Integer): boolean;
begin
  Result := FantDsc_Specified;
end;
...
procedure titulosConsultarTitulosCP2OutTitulos.SetcodNtg(Index: Integer; const AInteger: Integer);
begin
  FcodNtg := AInteger;
  FcodNtg_Specified := True;
end;
...
procedure titulosConsultarTitulosCP2OutTitulos.SetdesMpt(Index: Integer; const Astring: string);
begin
  FdesMpt := Astring;
  FdesMpt_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.desMpt_Specified(Index: Integer): boolean;
begin
  Result := FdesMpt_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetdesPor(Index: Integer; const Astring: string);
begin
  FdesPor := Astring;
  FdesPor_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.desPor_Specified(Index: Integer): boolean;
begin
  Result := FdesPor_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetdesSit(Index: Integer; const Astring: string);
begin
  FdesSit := Astring;
  FdesSit_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.desSit_Specified(Index: Integer): boolean;
begin
  Result := FdesSit_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetdesTpt(Index: Integer; const Astring: string);
begin
  FdesTpt := Astring;
  FdesTpt_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.desTpt_Specified(Index: Integer): boolean;
begin
  Result := FdesTpt_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetdscNeg(Index: Integer; const Astring: string);
begin
  FdscNeg := Astring;
  FdscNeg_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.dscNeg_Specified(Index: Integer): boolean;
begin
  Result := FdscNeg_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetfilNfv(Index: Integer; const Astring: string);
begin
  FfilNfv := Astring;
  FfilNfv_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.filNfv_Specified(Index: Integer): boolean;
begin
  Result := FfilNfv_Specified;
end;
...
procedure titulosConsultarTitulosCP2OutTitulos.SetnomFor(Index: Integer; const Astring: string);
begin
  FnomFor := Astring;
  FnomFor_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.nomFor_Specified(Index: Integer): boolean;
begin
  Result := FnomFor_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetnumNfv(Index: Integer; const Astring: string);
begin
  FnumNfv := Astring;
  FnumNfv_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.numNfv_Specified(Index: Integer): boolean;
begin
  Result := FnumNfv_Specified;
end;
...
procedure titulosConsultarTitulosCP2OutTitulos.SetproJrs(Index: Integer; const Astring: string);
begin
  FproJrs := Astring;
  FproJrs_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.proJrs_Specified(Index: Integer): boolean;
begin
  Result := FproJrs_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetsigFil(Index: Integer; const Astring: string);
begin
  FsigFil := Astring;
  FsigFil_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.sigFil_Specified(Index: Integer): boolean;
begin
  Result := FsigFil_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetsitTit(Index: Integer; const Astring: string);
begin
  FsitTit := Astring;
  FsitTit_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.sitTit_Specified(Index: Integer): boolean;
begin
  Result := FsitTit_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetsnfNfv(Index: Integer; const Astring: string);
begin
  FsnfNfv := Astring;
  FsnfNfv_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.snfNfv_Specified(Index: Integer): boolean;
begin
  Result := FsnfNfv_Specified;
end;
...
procedure titulosConsultarTitulosCP2OutTitulos.SetvctPro(Index: Integer; const Astring: string);
begin
  FvctPro := Astring;
  FvctPro_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.vctPro_Specified(Index: Integer): boolean;
begin
  Result := FvctPro_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetvlrAbe(Index: Integer; const Astring: string);
begin
  FvlrAbe := Astring;
  FvlrAbe_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.vlrAbe_Specified(Index: Integer): boolean;
begin
  Result := FvlrAbe_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetvlrAcr(Index: Integer; const Astring: string);
begin
  FvlrAcr := Astring;
  FvlrAcr_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.vlrAcr_Specified(Index: Integer): boolean;
begin
  Result := FvlrAcr_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetvlrCor(Index: Integer; const Astring: string);
begin
  FvlrCor := Astring;
  FvlrCor_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.vlrCor_Specified(Index: Integer): boolean;
begin
  Result := FvlrCor_Specified;
end;
...
procedure titulosConsultarTitulosCP2OutTitulos.SetvlrMul(Index: Integer; const Astring: string);
begin
  FvlrMul := Astring;
  FvlrMul_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.vlrMul_Specified(Index: Integer): boolean;
begin
  Result := FvlrMul_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetvlrOde(Index: Integer; const Astring: string);
begin
  FvlrOde := Astring;
  FvlrOde_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.vlrOde_Specified(Index: Integer): boolean;
begin
  Result := FvlrOde_Specified;
end;
...
procedure titulosConsultarTitulosCP2OutTitulos.SetvlrPag(Index: Integer; const Astring: string);
begin
  FvlrPag := Astring;
  FvlrPag_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.vlrPag_Specified(Index: Integer): boolean;
begin
  Result := FvlrPag_Specified;
end;

procedure titulosConsultarTitulosCP2OutTitulos.SetvlrTot(Index: Integer; const Astring: string);
begin
  FvlrTot := Astring;
  FvlrTot_Specified := True;
end;

function titulosConsultarTitulosCP2OutTitulos.vlrTot_Specified(Index: Integer): boolean;
begin
  Result := FvlrTot_Specified;
end;
